...
Volant::Config::default_organization_code = 'SDA'


# TODO - do it better
require "#{RAILS_ROOT}/app/models/apply_form_state.rb"
require "#{RAILS_ROOT}/app/models/cancelled_state.rb"
require "#{RAILS_ROOT}/app/models/apply_form_mail.rb"
